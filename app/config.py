...
class Settings:
    ...
    DATABASE_URL = os.getenv("DATABASE_URL", "postgresql://neondb_owner:npg_UoOMjHr5F9Ab@ep-summer-tooth-al96eadj-pooler.c-3.eu-central-1.aws.neon.tech/neondb?sslmode=require&channel_binding=require")
